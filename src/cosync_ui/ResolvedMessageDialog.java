...
public class ResolvedMessageDialog {

	public ResolvedMessageDialog(Shell parentShell) {
		build(parentShell);	
	}
	...
	private void build(Shell parentShell) {
		...
		messageLabel.setText("All conflicts have been resolved. Models are consistent.");
